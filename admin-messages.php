...
<div class="mb-5" id="hero-slider">
    <div class="container py-5">
        <div class="row">
            <h1 class="display-4">Messages panel</h1>
            <p class="ms-2 lead col-5 py-2" id="hero-paragraf">View all of the messages</p>
        </div>
    </div>
</div>
...
<div class="mb-5">
    <div class="container">
        <div class="row">
            <h3 class="lead  p-3 display-5 mb-3">Message inbox</h3>
            <p class="lead col-md-5 bg-light mb-5 p-3">Here you can mannage all messages that were received</p>
