...
<div class="mb-5" id="hero-slider">
    <div class="container py-5">
        <div class="row">
            <h1 class="display-4"><?php echo $_SESSION['loggedUser']->first_name?>'s orders</h1>
            <p class="ms-2 lead col-5 py-2" id="hero-paragraf">View all of your transactions</p>
        </div>
    </div>
</div>
...
<div class="mb-5">
    <div class="container">
        <div class="row">
            ...
            <p class="lead col-md-5 bg-light mb-5 p-3">Here you can see all orders you made</p>
